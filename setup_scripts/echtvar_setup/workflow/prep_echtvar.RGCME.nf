// RGC-ME data is build on GRCh38.
// Decomposed data.
// Without chr prefix.
...
params.echtvar_json_37 = "${projectDir}/echtvar_json/rgcme_remap37.json"
params.echtvar_json_38 = "${projectDir}/echtvar_json/rgcme_GRCh38.json"
...
process ENCODE_38 {
    ...
    output:
    path 'RGC_ME_GRCh38.echtvar.zip'

    script:
    """
    echtvar encode \\
      RGC_ME_GRCh38.echtvar.zip \\
      ${config_json} \\
      ${input_data}
    """
}
...
process ENCODE_37 {
    ...
    output:
    path 'RGC_ME_GRCh37.echtvar.zip'

    script:
    """
    echtvar encode \\
      RGC_ME_GRCh37.echtvar.zip \\
      ${config_json} \\
      ${input_data}
    """
}
...
workflow {
    Channel.fromPath( "${params.input}/${params.rgc_me}" )
      | map { vcf_file ->
