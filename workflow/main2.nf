...
params.input = ''    
params.ped = ''       // A PED file path
params.bams_dir = ''  // A directory containing BAM with index files
params.xhmm_dir = ''  // A directory containing XHMM output files (auto, XX, and XY)
params.phenotype = '' // A phenotype file path (optional)
...
process JIGV {
    publishDir "${params.output}/jigv-html", mode: 'move'
